...
class Config:
    ...
    SQL_DATABASE_URI: Optional[str] =  'sqlite://db.sqlite3'
...
class ProdConfig(Config):
    ...
    SQL_DATABASE_URI: str = os.getenv("DB_URI")


class LocalConfig(Config):
    SECRET_KEY: str = "my jwt secret"
    SQL_DATABASE_URI: str =  'sqlite://db.sqlite3'
